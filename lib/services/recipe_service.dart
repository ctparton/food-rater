...
class RecipeService {
  ...
  /// successful, else returns null or throws an error.
  ...
  /// Attempts to get the cuisine of the [mealName]
  ///
  /// Returns a [String] of the cuisine type if successful, else returns null
  /// or an error
